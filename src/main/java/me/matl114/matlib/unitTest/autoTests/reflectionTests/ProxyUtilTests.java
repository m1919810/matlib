...
public class ProxyUtilTests implements TestCase {
    ...
    public void test_simple_proxy() throws Throwable {
        ...
        Initialization init =
                ProxyBuilder.buildMatlibAdaptorOf(Initialization.class, instance, SimpleRemappingInvocation::new);
        ...
        Debug.logger(access);
        LockFactory<Location> locationLockFactory =
                ProxyBuilder.buildMatlibAdaptorOf(LockFactory.class, access, SimpleRemappingInvocation::new);
    ...
    public static interface DemoProxy extends TargetDescriptor {
        ...
        default void notComplete(Object target, boolean val) {
            ...
            try {
                MethodHandles.Lookup lookup1 = MethodHandles.privateLookupIn(
                        ObfManager.getManager().reobfClass("net.minecraft.world.item.ItemStack"),
