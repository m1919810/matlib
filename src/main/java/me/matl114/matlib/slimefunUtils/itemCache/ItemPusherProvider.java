...
public interface ItemPusherProvider {
    ...
    default IntFunction<ItemPusher> getMenu(
            Flags settings, BlockMenu inv, IntFunction<ItemStack> stackFunction, int[] slots) {
    ...
    default IntFunction<ItemPusher> getMenuInstance(
            Flags settings, BlockMenu blockMenu, ItemStack[] item, int[] slots) {
        return getMenu(settings, blockMenu, (i) -> item[i], slots);
    }

    default IntFunction<ItemPusher> getMenuInstance(
            Flags settings, BlockMenu blockMenu, IntFunction<ItemStack> prov, int[] slots) {
