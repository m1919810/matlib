...
class ItemMetaViewImpl_1_21_R4 extends ItemMetaViewImpl_1_20_R4 {
        ...
        if (tooltips != null) {
            ...
            if (hidden.containsAll(hides) == !shouldDisplay) {
                ...
                if (!newSet.isEmpty() || hideFlag) {
                    HELPER.setDataComponentValue(
                            ...
                            DATA_TYPES.tooltipsDisplay$newComponent(hideFlag, newSet));
                } else {
            ...
            if (!shouldDisplay) {
                ...
                HELPER.setDataComponentValue(
                        itemStack,
                        DataComponentEnum.TOOLTIP_DISPLAY,
                        DATA_TYPES.tooltipsDisplay$newComponent(false, new ReferenceLinkedOpenHashSet<>(hides)));
            }
        }
    }
    ...
    public void setHideTooltip(boolean b) {
        ...
        if (tooltips != null) {
            ...
            if (!set.isEmpty() || b) {
                HELPER.setDataComponentValue(
                        itemStack, DataComponentEnum.TOOLTIP_DISPLAY, DATA_TYPES.tooltipsDisplay$newComponent(b, set));
            } else {
            ...
            if (b) {
                HELPER.setDataComponentValue(
                        itemStack,
                        DataComponentEnum.TOOLTIP_DISPLAY,
                        DATA_TYPES.tooltipsDisplay$newComponent(true, new ReferenceLinkedOpenHashSet<>()));
            }
        }
    }
}
