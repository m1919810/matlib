...
public interface CompoundTagHelper_v1_21_R4 extends CompoundTagHelper {
    ...
    default byte[] getByteArray(Object nbt, String key) {
        ...
        return val == null
                ? new byte[0]
                : (TAGS.getId(val) == TagEnum.TAG_BYTE_ARRAY ? TAGS.getAsByteArray(val) : new byte[0]);
    }
    ...
    default int[] getIntArray(Object nbt, String key) {
        ...
        return val == null
                ? new int[0]
                : (TAGS.getId(val) == TagEnum.TAG_INT_ARRAY ? TAGS.getAsIntArray(val) : new int[0]);
    }
    ...
    default long[] getLongArray(Object nbt, String key) {
        ...
        return val == null
                ? new long[0]
                : (TAGS.getId(val) == TagEnum.TAG_LONG_ARRAY ? TAGS.getAsLongArray(val) : new long[0]);
    }
