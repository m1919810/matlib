...
public interface FormatHelper extends TargetDescriptor {
    ...
    default Object newStyle(
            @RedirectType(TextColor) Object color,
            @Nullable Boolean bold,
            @Nullable Boolean italic,
            @Nullable Boolean underlined,
            @Nullable Boolean strikethrough,
            @Nullable Boolean obfuscated,
            @RedirectType(ClickEvent) Object clickevent,
            @RedirectType(HoverEvent) Object hoverEvent,
            String insertion,
            @RedirectType(ResourceLocation) Object resourceLocation) {
        return newStyle0(
                color,
                null,
                bold,
    ...
    default Object createShowItem(@RedirectType(ItemStack) Object rawContent) {
        return newHoverEvent(
                ChatUtils.toNMSHoverAction(net.kyori.adventure.text.event.HoverEvent.Action.SHOW_ITEM),
                newHoverEventItemInfo(rawContent));
    }
    ...
    default Object createShowText(@RedirectType(ChatComponent) Object textContent) {
        return newHoverEvent(
                ChatUtils.toNMSHoverAction(net.kyori.adventure.text.event.HoverEvent.Action.SHOW_TEXT), textContent);
    }
