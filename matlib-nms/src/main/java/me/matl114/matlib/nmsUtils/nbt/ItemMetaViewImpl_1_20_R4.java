...
class ItemMetaViewImpl_1_20_R4 extends AbstractItemMetaView {
    ...
    protected class EnchantmentKeyMappingObject2IntMap extends AbstractObject2IntMap<Enchantment> {
        ...
        public void init() {
            ...
            this.itemEnchantsMutable = Env1_20_R4.DATA_TYPES.newMutable(itemEnchants);
            this.rawMap = Env1_20_R4.DATA_TYPES.itemEnchantMutable$enchants(this.itemEnchantsMutable);
            this.immutableView = Env1_20_R4.DATA_TYPES.itemEnchantMutable$toImmutable(this.itemEnchantsMutable);
    ...
    public @Nullable Component displayName() {
        return CraftBukkit.ADVENTURE.asAdventure(nmsNameView.get());
    }

    @Override
    public void displayName(@Nullable Component component) {
        nmsNameView.set(CraftBukkit.ADVENTURE.asVanilla(component));
    }
    ...
    public @Nullable List<Component> lore() {
        return this.nmsLoreView.isEmpty() ? null : CraftBukkit.ADVENTURE.asAdventure(this.nmsLoreView);
    }

    @Override
    public void lore(@Nullable List<? extends Component> list) {
        CollectionUtils.mapAndSet(list, CraftBukkit.ADVENTURE::asVanilla, this.nmsLoreView);
    }
    ...
    public int getCustomModelData() {
        ...
        return (Integer) CodecUtils.encodeEnd(ComponentCodecEnum.CUSTOM_MODEL_DATA.encodeStart(TypeOps.I, value));
    }
    ...
    public void setCustomModelData(@Nullable Integer integer) {
        if (integer == null) {
            ...
            HELPER.setDataComponentValue(
                    ...
                    CodecUtils.result(ComponentCodecEnum.CUSTOM_MODEL_DATA.decode(TypeOps.I, integer)));
        }
    }
    ...
    public void setEnchantable(@Nullable Integer integer) {
        if (integer == null) {
            ...
            HELPER.setDataComponentValue(
                    ...
                    CodecUtils.result(version(ComponentCodecEnum.ENCHANTABLE).decode(TypeOps.I, integer)));
        }
    }
    ...
    private static final Object UNBREAKABLE_TOOLTIPS =
            CodecUtils.decode(ComponentCodecEnum.UNBREAKABLE, TypeOps.I, Map.of("show_in_tooltip", true));
    private static final Object UNBREAKABLE_NO_TOOLTIPS =
            CodecUtils.decode(ComponentCodecEnum.UNBREAKABLE, TypeOps.I, Map.of("show_in_tooltip", false));
    ...
    protected void setFlag(ItemFlag flag, boolean shouldDisplay) {
        ...
        switch (flag) {
            case HIDE_ENCHANTS:
                ...
                //                    break;
                //                }
                Env1_20_R4.DATA_TYPES.itemEnchantMutable$setShowInTooltip(mmmap.itemEnchantsMutable, shouldDisplay);
                mmmap.immutableView = Env1_20_R4.DATA_TYPES.itemEnchantMutable$toImmutable(mmmap.itemEnchantsMutable);
                mmmap.writeBack();
                break;
            case HIDE_ADDITIONAL_TOOLTIP:
                ...
                break;
            case HIDE_DESTROYS:
                Env1_20_R4.DATA_TYPES.toggleTooltipsAtType(HELPER_CAN_BREAK, itemStack, shouldDisplay);
                break;
            case HIDE_PLACED_ON:
                Env1_20_R4.DATA_TYPES.toggleTooltipsAtType(HELPER_CAN_PLACE_ON, itemStack, shouldDisplay);
                break;
            case HIDE_UNBREAKABLE:
                Env1_20_R4.DATA_TYPES.toggleTooltipsAtType(HELPER_UNBREAKABLE, itemStack, shouldDisplay);
                break;
            case HIDE_ATTRIBUTES:
                Env1_20_R4.DATA_TYPES.toggleTooltipsAtType(HELPER_ATTRIBUTE_MODIFIERS, itemStack, shouldDisplay);
                break;
            case HIDE_STORED_ENCHANTS:
                Env1_20_R4.DATA_TYPES.toggleTooltipsAtType(HELPER_STORED_ENCHANTMENTS, itemStack, shouldDisplay);
                break;
            case HIDE_ARMOR_TRIM:
                Env1_20_R4.DATA_TYPES.toggleTooltipsAtType(HELPER_TRIM, itemStack, shouldDisplay);
                break;
            case HIDE_DYE:
                Env1_20_R4.DATA_TYPES.toggleTooltipsAtType(HELPER_DYED_COLOR, itemStack, shouldDisplay);
                break;
            default:
    ...
    protected boolean getVisibilityForFlag(ItemFlag flag) {
        ...
        switch (flag) {
            case HIDE_ENCHANTS:
                ...
                return Env1_20_R4.DATA_TYPES.itemEnchantMutable$showInTooltip(mmmap.itemEnchantsMutable);
            case HIDE_ADDITIONAL_TOOLTIP:
            ...
            case HIDE_PLACED_ON:
                ...
                return predicate == null || Env1_20_R4.DATA_TYPES.adventureModePredicate$showInTooltip(predicate);
            case HIDE_UNBREAKABLE:
                Object unbreakable = HELPER.getFromPatch(itemStack, DataComponentEnum.UNBREAKABLE);
                if (unbreakable == null) return true;
                Map encodeValue = (Map) CodecUtils.encode(ComponentCodecEnum.UNBREAKABLE, TypeOps.I, unbreakable);
            ...
            case HIDE_ATTRIBUTES:
                ...
                if (itemModifier != null) {
                    return Env1_20_R4.DATA_TYPES.itemAttributeModifiers$showInTooltip(itemModifier);
                }
                return true;
            case HIDE_STORED_ENCHANTS:
                Object storedItemEnchant = HELPER.getFromPatch(itemStack, DataComponentEnum.STORED_ENCHANTMENTS);
                if (storedItemEnchant != null) {
                    return Env1_20_R4.DATA_TYPES.itemEnchants$ShowTooltip(storedItemEnchant);
                }
                return true;
            case HIDE_ARMOR_TRIM:
                Object trim = HELPER.getFromPatch(itemStack, DataComponentEnum.TRIM);
                if (trim != null) {
                    return Env1_20_R4.DATA_TYPES.armorTrim$showInTooltip(trim);
                }
                return true;
            case HIDE_DYE:
                Object dye = HELPER.getFromPatch(itemStack, DataComponentEnum.DYED_COLOR);
                if (dye != null) {
                    return Env1_20_R4.DATA_TYPES.dyeItemColor$showInTooltip(dye);
                }
                return true;
            default:
                throw new IllegalArgumentException("Unexpected item flag " + flag);
    ...
    public @Nullable Tag<DamageType> getDamageResistant() {
        Codec<Object> codec = version(ComponentCodecEnum.DAMAGE_RESISTANT);
    ...
    public @Nullable ItemStack getUseRemainder() {
        ...
        return item == null ? null : ItemUtils.asCraftMirror(Env1_20_R4.DATA_TYPES.useRemainder$Remain(item));
    }
    ...
    public @NotNull UseCooldownComponent getUseCooldown() {
        ...
        return (UseCooldownComponent)
                (val != null
                        ? Env1_20_R4.DATA_TYPES.useCooldownComponent$Craft(val)
                        : Env1_20_R4.DATA_TYPES.useCooldownComponent$Craft(Env1_20_R4.DATA_TYPES.newUseCooldown(1.0f)));
    }
    ...
    public void setUseCooldown(@Nullable UseCooldownComponent useCooldownComponent) {
        if (useCooldownComponent == null) {
            ...
            HELPER.setDataComponentValue(
                    ...
                    Env1_20_R4.DATA_TYPES.useCooldownComponent$Handle(useCooldownComponent));
        }
    }
    ...
    public @NotNull FoodComponent getFood() {
        ...
        return val != null ? Env1_20_R4.DATA_TYPES.foodProperties$Craft(val) : SAMPLE_META.getFood();
    }
    ...
    public void setFood(@Nullable FoodComponent foodComponent) {
        if (foodComponent == null) {
            ...
            HELPER.setDataComponentValue(
                    itemStack, DataComponentEnum.FOOD, Env1_20_R4.DATA_TYPES.foodProperties$Handle(foodComponent));
        }
    }
    ...
    public @NotNull ToolComponent getTool() {
        ...
        return val != null ? Env1_20_R4.DATA_TYPES.tool$Craft(val) : SAMPLE_META.getTool();
    }
    ...
    public void setEquippable(@Nullable EquippableComponent equippableComponent) {
        if (equippableComponent == null) {
            ...
            HELPER.setDataComponentValue(
                    ...
                    Env1_20_R4.DATA_TYPES.equippable$Handle(equippableComponent));
        }
    }
    ...
    public @NotNull JukeboxPlayableComponent getJukeboxPlayable() {
        ...
        return val != null
                ? (JukeboxPlayableComponent) Env1_20_R4.DATA_TYPES.jukebox$Craft(val)
    ...
    public void setJukeboxPlayable(@Nullable JukeboxPlayableComponent jukeboxPlayableComponent) {
        if (jukeboxPlayableComponent == null) {
            ...
            HELPER.setDataComponentValue(
                    ...
                    Env1_20_R4.DATA_TYPES.jukebox$Handle(jukeboxPlayableComponent));
        }
    }
    ...
    protected void syncModifierChange() {
        ...
        if (mdMap.isEmpty()) {
            ...
            Object builder = Env1_20_R4.DATA_TYPES.itemAttributeModifierBuilder();
            for (var entry : mdMap.entries()) {
                ...
                Env1_20_R4.DATA_TYPES.attributeBuilder$Add(builder, attrHolder, attrNMS, nmsSlot);
            }
            Object itemAttribute = Env1_20_R4.DATA_TYPES.attributeBuilder$Build(builder);
            HELPER.setDataComponentValue(itemStack, DataComponentEnum.ATTRIBUTE_MODIFIERS, itemAttribute);
            // restore tooltips
            if (!showAttribute) {
                Env1_20_R4.DATA_TYPES.toggleTooltipsAtType(HELPER_ATTRIBUTE_MODIFIERS, itemStack, false);
            }
        }
    }
    ...
    public @NotNull String getAsComponentString() {
        ...
        DynamicOps<?> nbtop = DynamicOpUtils.nbtOp();
        StringJoiner stringJoiner = new StringJoiner(",", "[", "]");
        for (var entry : Env1_20_R4.COMPONENT_PATCH.entrySet(patch)) {
