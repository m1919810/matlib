...
abstract class AbstractItemMetaView implements ItemMetaView {
    ...
    public AbstractItemMetaView(Object itemStack) {
        ...
        this.nmsNameView = NMSItem.ITEMSTACK.getDisplayNameView(itemStack);
        this.nmsLoreView = NMSItem.ITEMSTACK.getLoreView(itemStack, true);
    }
    ...
    public boolean hasDisplayName() {
        return NMSItem.ITEMSTACK.hasCustomHoverName(itemStack);
    }
    ...
    public boolean hasLore() {
        return NMSItem.ITEMSTACK.hasLore(itemStack);
    }
    ...
    public Object getAsTag() {
        return NMSItem.ITEMSTACK.saveNbtAsTag(itemStack);
    }
    ...
    public PersistentDataContainer getInternalNbt() {
        return new TagCompoundView(NMSItem.ITEMSTACK.getCustomedNbtView(this.itemStack, false));
    }
}
