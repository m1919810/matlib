    ...
    public void test_bigitem(){
        ...
        for (var iter : getTestCases("itemstack/big_fish_item.json")) {
            ...
            for (var i = 0; i < 1_000_000; ++i){
                ...
                metaView.getPersistentDataContainer().set(NamespacedKey.fromString("magicexpansion:fish_weight"), PersistentDataType.DOUBLE, d);
                metaView.removeLore(2);
                metaView.addLoreAt(1, TextUtils.resolveColor("&x&f&d&b&7&d&4重&x&f&b&9&1&b&e量&x&f&b&7&7&b&3:&x&f&f&6&9&b&4 &f%.3f kg".formatted(d)));
