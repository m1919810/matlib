...
public abstract class RobotRoot implements RobotConfigure {
    ...
    @Override
    public abstract void setRootLocation(Location loc);
    //    {
    //        setCoreLocation(loc);
    //        updateConfiguration();
    //    }
    ...
    public abstract TransformationUtils.LCTransformation getCurrentTransformation();

    public abstract void forwardKinematics(MatrixStack stack, RobotRoot root);
