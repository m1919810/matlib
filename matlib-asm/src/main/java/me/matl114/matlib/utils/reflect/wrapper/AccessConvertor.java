...
public class AccessConvertor {
    public static AsmArgument<me.matl114.matlib.utils.reflect.reflectasm.MethodAccess> convertMethodAccess(
        ...
        try {
            me.matl114.matlib.utils.reflect.reflectasm.MethodAccess fastAccessInternal =
    ...
    public static AsmArgument<me.matl114.matlib.utils.reflect.reflectasm.FieldAccess> convertFieldAccess(
    ...
    public static record AsmArgument<T>(T access, int index) {
        public FieldAccessor<?> createFieldAccessor() {
            return createASMAccessor((AsmArgument<me.matl114.matlib.utils.reflect.reflectasm.FieldAccess>) this);
        }

        public MethodInvoker<?> createMethodInvoker() {
            return createASMInvoker((AsmArgument<me.matl114.matlib.utils.reflect.reflectasm.MethodAccess>) this);
        }
    }
}
