...
public class FieldAccess {
    ...
    private Field getFieldInternal(Object obj) throws Throwable {
        ...
        Preconditions.checkArgument(
                field != null,
                "FieldAccess init field failed: field is null! using argument: "
        ...
        if (this.field == null && !failInitialization) {
            try {
                ...
                if (createSnapshot) {
                    ...
                    try {
                        this.handle = MethodHandles.privateLookupIn(
                                        this.field.getDeclaringClass(), MethodHandles.lookup())
                                .unreflectVarHandle(this.field);
    ...
    private FieldSetter setterInternal() {
        if (staticField && finalField) {
            return (o, v) -> {
                throw new RuntimeException("Static final field can only be set using setUnsafe! Field:" + this.field);
            };
        } else {
            return (o, v) -> {
                try {
