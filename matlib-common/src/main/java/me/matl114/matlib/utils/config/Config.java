...
public abstract class Config {
        ...
        protected void loadInternal(Map<String, Object> value) {
            for (Map.Entry<String, Object> entry : value.entrySet()) {
                ...
                if (val instanceof Map map) {
                    ...
                    InnerNode newNode =
                            node.addOrGetChild(keySplit[keySplit.length - 1], InnerNode.class, InnerNode::new);
    ...
    protected final class RootNode extends InnerNode {
        public RootNode() {
            ...
            Preconditions.checkArgument(
                    Config.this.root == null || !Config.this.root.isValid(),
                    "Node Error in Config! this Config Tree already has a Root");
    ...
    @Nullable private InnerNode getNode(String[] path) {
    ...
    @Nullable private InnerNode getParentNode(String[] path) {
    ...
    @Nullable public <T> T getValue(String path) {
