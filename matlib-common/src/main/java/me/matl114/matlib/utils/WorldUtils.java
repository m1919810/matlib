...
public class WorldUtils {
    ...
    private static final FieldAccess blockPositionFieldAccess = new InitializeSafeProvider<>(
                    () -> {
                        var BlockPositionField = ReflectUtils.getFieldsRecursively(craftBlockStateClass, "position")
                                .getA();
    ...
    private static final FieldAccess worldFieldAccess = new InitializeSafeProvider<>(
                    () -> {
                        var WorldField = ReflectUtils.getFieldsRecursively(craftBlockStateClass, "world")
                                .getA();
    ...
    private static final FieldAccess weakWorldFieldAccess = new InitializeSafeProvider<>(
                    () -> {
                        var WeakWorldField = ReflectUtils.getFieldsRecursively(craftBlockStateClass, "weakWorld")
                                .getA();
                    ...
                    FieldAccess.ofFailure())
            .v();
    private static final boolean invokeBlockStateSuccess = blockPositionFieldAccess != FieldAccess.ofFailure()
            && worldFieldAccess != FieldAccess.ofFailure()
            && weakWorldFieldAccess != FieldAccess.ofFailure();
    ...
    private static final VarHandle positionHandle = new InitializeSafeProvider<>(VarHandle.class, () -> {
            ...
            .runNonnullAndNoError(() -> Debug.logger("Successfully initialize Blockstate.position VarHandle"))
            .v();
    private static final VarHandle worldHandle = new InitializeSafeProvider<>(VarHandle.class, () -> {
            ...
            .runNonnullAndNoError(() -> Debug.logger("Successfully initialize Blockstate.world VarHandle"))
            .v();
    private static final VarHandle weakWorldHandle = new InitializeSafeProvider<>(VarHandle.class, () -> {
            ...
            .runNonnullAndNoError(() -> Debug.logger("Successfully initialize Blockstate.weakWorld VarHandle"))
            .v();
    private static final boolean handleBlockStateSuccess =
            positionHandle != null && worldHandle != null && weakWorldHandle != null;
    ...
    private static final VarHandle worldWorldHandle = new InitializeSafeProvider<>(VarHandle.class, () -> {
            ...
            .runNonnullAndNoError(() -> Debug.logger("Successfully initialize CraftWorld.world VarHandle"))
            .v();
    ...
    private static final FieldAccess tileEntityAccess = Holder.of(
                    FieldAccess.ofName(craftBlockEntityStateClass, "tileEntity"))
            ...
            .checkArgument(FieldAccess::successfullyInitialized)
            .runException((w) -> {
                throw new RuntimeException("Failed to initialize CraftBlockEntityState.blockEntity VarHandle");
            })
            .get();
    ...
    private static final VarHandle tileEntityHandle = new InitializeSafeProvider<>(VarHandle.class, () -> {
            ...
            .runNonnullAndNoError(() -> Debug.logger("Successfully initialize BlockEntityState.tileEntity VarHandle"))
            .v();
    ...
    private static final VarHandle tileEntityRemovalHandle = new InitializeSafeProvider<>(VarHandle.class, () -> {
            ...
            .runNonnullAndNoError(() -> Debug.logger("Successfully initialize TileEntity.remove VarHandle"))
            .v();
    ...
    private static final MethodInvoker<Void> tileEntitySetChangeMethodInvoker = Holder.of(tileEntitySetChangeAccess)
