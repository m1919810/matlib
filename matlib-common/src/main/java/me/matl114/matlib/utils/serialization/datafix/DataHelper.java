...
public interface DataHelper extends TargetDescriptor {
    ...
    @MethodTarget
    public boolean isSuccess(DataResult<?> result);

    @MethodTarget
    public <U, T> DataResult<T> map(DataResult<U> data, Function<? super U, ? extends T> function);
    ...
    public static interface A {
        DataHelper I = Objects.requireNonNullElseGet(
                DescriptorBuilder.createASMMultiHelper(DataHelper.class),
                () -> P.I); // DescriptorImplBuilder.createMultiHelper(DataHelper.class);
    }
